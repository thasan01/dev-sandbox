--Users
INSERT INTO app_user (user_name, email, status) VALUES ('user1', 'user1@doamin.com', 0); --id=1
INSERT INTO app_user (user_name, email, status) VALUES ('user2', 'user2@doamin.com', 0); --id=2
INSERT INTO app_user (user_name, email, status) VALUES ('user3', 'user3@doamin.com', 0); --id=3
INSERT INTO app_user (user_name, email, status) VALUES ('user4', 'user4@doamin.com', 0); --id=4
INSERT INTO app_user (user_name, email, status) VALUES ('user5', 'user5@doamin.com', 0); --id=5
INSERT INTO app_user (user_name, email, status) VALUES ('user6', 'user6@doamin.com', 0); --id=6
INSERT INTO app_user (user_name, email, status) VALUES ('user7', 'user7@doamin.com', 0); --id=7
INSERT INTO app_user (user_name, email, status) VALUES ('user8', 'user8@doamin.com', 0); --id=8
INSERT INTO app_user (user_name, email, status) VALUES ('user9', 'user9@doamin.com', 0); --id=9
INSERT INTO app_user (user_name, email, status) VALUES ('user10', 'user10@doamin.com', 1); --id=10
